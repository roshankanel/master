...
permissions_list = [
  ...
  ["create store", "Create permission for stores", "Stores"],
  ["update store", "Update permission for stores", "Stores"],
  ["read store", "Read only permissoin for stores", "Stores"],
  ["delete store", "Delete permissoin for stores", "Stores"],
  ["view store details", "Show store details", "Stores"],
